...
La même règle vaut dans l'autre sens, et il faut donc le dire clairement. En comparant la version 9.9.0 telle que publiée à la version 10.0.0 telle que publiée, sur le même enregistrement de 6,5 minutes, la voie GPU est devenue 36x plus rapide (de 1078 s à 30 s) tandis que la voie CPU n'a pas bougé de façon mesurable (de 103 s à 103 s, intervalle de confiance à 95 % de 0,95 à 1,10). Plusieurs des changements CPU ci-dessus mesuraient bien isolément et ne totalisent malgré tout pas un écart que la machine de référence sait distinguer de son propre bruit. Ils sont conservés parce que chacun est solide et parce qu'une machine plus lente ou plus chargée n'est pas celle-ci, non parce qu'il est établi qu'ils vous aideront.
