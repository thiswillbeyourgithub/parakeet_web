...
// Sending a benchmark report anywhere is off unless the operator turns it on.
// The section's whole premise is that nothing leaves the browser without an
// explicit action, and on an instance with no collector there is no Send
// button to explain. Passed down to BenchmarkSection rather than read there,
// so the auto-send path below and the button agree by construction.
      ...
      {showSettings && (
        ...
        >
          <GeneralSection
            ...
            setTranscriptDisplayMode={setTranscriptDisplayMode}
            dictationRegexRules={dictationRegexRules}
            diarizationModelError={diarizationModelError}
            diarizationNumSpeakers={diarizationNumSpeakers}
            setDiarizationNumSpeakers={setDiarizationNumSpeakers}
          />
          ...
          <BoostingSection
            t={t}
            open={!!sectionsOpen.boosting}
            onToggle={toggleBoostingSection}
            boostFiles={boostFiles}
            boostSource={boostSource}
            applyBoostSource={applyBoostSource}
            boostStrength={boostStrength}
            setBoostStrength={setBoostStrength}
            boostCollapsed={boostCollapsed}
            boostCustomOversize={boostCustomOversize}
            boostEditorOpen={boostEditorOpen}
            setBoostEditorOpen={setBoostEditorOpen}
            boostLineCount={boostLineCount}
            boostPhrases={boostPhrases}
            setBoostPhrases={setBoostPhrases}
            setBoostCustomText={setBoostCustomText}
            boostPhraseCount={boostPhraseCount}
            boostWarnings={boostWarnings}
            boostConflicts={boostConflicts}
            boostUnkWarnings={boostUnkWarnings}
            boostMinp={boostMinp}
            setBoostMinp={setBoostMinp}
            boostDepthScaling={boostDepthScaling}
          ...
          <BenchmarkSection
            t={t}
            open={!!sectionsOpen.benchmark}
            onToggle={toggleSection}
            benchmarkPlan={benchmarkPlan}
            benchmarkSelected={benchmarkSelected}
            setBenchmarkSelected={setBenchmarkSelected}
            benchmarkRunning={benchmarkRunning}
            benchmarkLongProfile={benchmarkLongProfile}
            setBenchmarkLongProfile={setBenchmarkLongProfile}
            benchmarkRepeats={benchmarkRepeats}
            setBenchmarkRepeats={setBenchmarkRepeats}
            isTranscribing={isTranscribing}
            runBenchmark={runBenchmark}
            onCancel={() => { benchmarkCancelRef.current = true; setBenchmarkProgress(t('benchmarkCancelling')); }}
            benchmarkProgress={benchmarkProgress}
            benchmarkDone={benchmarkDone}
            benchmarkResults={benchmarkResults}
            benchmarkReport={benchmarkReport}
            benchmarkReportRef={benchmarkReportRef}
            copyBenchmarkReport={copyBenchmarkReport}
            benchmarkCopied={benchmarkCopied}
            uploadEnabled={BENCHMARK_UPLOAD_ENABLED}
            benchmarkSendState={benchmarkSendState}
            sendBenchmarkReport={sendBenchmarkReport}
            benchmarkAutoSend={benchmarkAutoSend}
            setBenchmarkAutoSend={setBenchmarkAutoSend}
          />
