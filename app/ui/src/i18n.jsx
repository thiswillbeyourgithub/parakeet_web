...
const translations = {
  en: {
    ...
    relaxedSimd: 'Relaxed-SIMD engine (experimental)',
    tooltipRelaxedSimd: 'Runs the speech engine on a Relaxed-SIMD build of ONNX Runtime, which speeds up the int8 matrix math on browsers that support the feature. Only shown when this deployment ships the alternate build and your browser supports it. The choice is applied at the first model load of the page: after changing it, reload the page. Default: off.',
  ...
  fr: {
    ...
    relaxedSimd: 'Moteur Relaxed-SIMD (expérimental)',
    tooltipRelaxedSimd: 'Exécute le moteur vocal sur une version Relaxed-SIMD de ONNX Runtime, qui accélère le calcul matriciel int8 sur les navigateurs compatibles. Visible uniquement quand ce déploiement fournit la version alternative et que votre navigateur la prend en charge. Le choix est appliqué au premier chargement du modèle de la page : après un changement, rechargez la page. Défaut : désactivé.',
