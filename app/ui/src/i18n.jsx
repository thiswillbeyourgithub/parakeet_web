...
const translations = {
  en: {
    ...
    dismiss: 'Dismiss',
    quantUnavailable: '⚠️ The requested encoder precision is not hosted on HuggingFace or on this instance: fp32 needs the <2 GB shards, and int8 lite and w4a8 each need their own encoder file. To avoid silently loading a different precision (int8) instead, the load was stopped. Ask the operator to host the missing files, or pick the int8 encoder.',
